...
class ImageAvatar {
    private:
        ...
        void init(bool isChange) {
            ...
            _lcd_sp->createSprite(_tft->width() + marginX * 2, _tft->height() + marginY * 2); // 傾けたときのマージン
    ...
    public:
        ...
        void drawAll() {
            ...
            _eyebrow_sp->pushRotateZoom(_lcd_sp
                    ,peb.rx + marginX, peb.ry + _mv.breath + marginY
                    , _mv.eyebrow_r_angle, 1, 1, peb.cmn.tpColor);
            _eyebrow_sp->pushRotateZoom(_lcd_sp
                    ,peb.lx + marginX, peb.ly + _mv.breath + marginY
            ...
            if (_mv.mouth_ratio <= pm.minScaleY) {
                ...
                _mouth_cl_sp->pushRotateZoom(_lcd_sp
                    , pm.x + marginX, pm.y + _mv.breath + marginY
            ...
            _eye_r_sp->pushRotateZoom(_lcd_sp
                    , pe.rx + marginX, pe.ry + _mv.breath + marginY
                    , 0, 1.0, 1.0, pe.cmn.tpColor);
            ...
            _eye_l_sp->pushRotateZoom(_lcd_sp
                    , pe.lx + marginX, pe.ly + _mv.breath + marginY
                    , 0, 1.0, 1.0, pe.cmn.tpColor);
